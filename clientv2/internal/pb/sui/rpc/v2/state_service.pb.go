...
const file_sui_rpc_v2_state_service_proto_rawDesc = "" +
	...
	"\fListBalances\x12\x1f.sui.rpc.v2.ListBalancesRequest\x1a .sui.rpc.v2.ListBalancesResponseB\xb3\x01\n" +
	"\x0ecom.sui.rpc.v2B\x11StateServiceProtoP\x01ZDgithub.com/utila-io/go-sui-sdk/clientv2/internal/pb/sui/rpc/v2;rpcv2\xa2\x02\x03SRX\xaa\x02\n" +
	"Sui.Rpc.V2\xca\x02\n" +
